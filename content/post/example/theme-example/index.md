---
title: "Theme Example"
date: 2019-09-21T14:33:47+08:00
draft: false
tags: ["even"]
categories: ["example"]
...
define anchor using `{#section-id}` at markdown title line.

reference `{#section-id}` using `[anchor to section-id](#section-id)`

[anchor to section-7](#section-7)
...
![Web Picture](https://i0.hdslb.com/bfs/album/7ab7bb97c0a3bd5438fba6eb28b35bb85ca7fda3.jpg@2000w_1e.webp "Web Picture")
...
in a line insert $p(x|y) = \frac{p(y|x)p(x)}{p(y)}$ as a example.
